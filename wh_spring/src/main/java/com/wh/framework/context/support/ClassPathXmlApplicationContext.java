...
import com.wh.framework.beans.factory.xml.XmlBeanDefinitionReader;
import com.wh.framework.support.BeanDefinitionRegistry;
import com.wh.framework.utils.StringUtils;
 ...
 * ioc容器具体的子类实现类,用于加载类路径下的xml格式的配置文件
 */
public class ClassPathXmlApplicationContext extends AbstractApplicationContext{
    ...
    public Object getBean(String name) throws Exception {
        //判断对象容器中是否包含指定名称的bean独此昂,如果包含,直接返回即可,如果不包含,需要自行创建
